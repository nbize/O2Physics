...
void o2::aod::dqhistograms::DefineHistograms(HistogramManager* hm, const char* histClass, const char* groupName, const char* subGroupName)
{
  ...
  if (groupStr.Contains("track")) {
    ...
    hm->AddHistogram(histClass, "ptVsEta", "eta vs pt", false, 20, -4.2, -2.2, VarManager::kEta, 100, 0., 20., VarManager::kPt);
    ...
    if (subGroupStr.Contains("kine")) {
      ...
      hm->AddHistogram(histClass, "Eta_Pt", "", false, 20, -4.2, -2.2, VarManager::kEta, 100, 0.0, 20.0, VarManager::kPt);
    ...
    if (subGroupStr.Contains("mc")) {
      hm->AddHistogram(histClass, "DeltaPt_100", "", false, 100, -1.0, 1.0, VarManager::kDeltaPt_check);
      hm->AddHistogram(histClass, "DeltaPt_200", "", false, 200, -1.0, 1.0, VarManager::kDeltaPt_check);
      hm->AddHistogram(histClass, "DeltaPt_500", "", false, 500, -1.0, 1.0, VarManager::kDeltaPt_check);
      hm->AddHistogram(histClass, "DeltaPt_100_wide", "", false, 100, -5.0, 5.0, VarManager::kDeltaPt_check);
      hm->AddHistogram(histClass, "DeltaPt_200_wide", "", false, 200, -5.0, 5.0, VarManager::kDeltaPt_check);
      hm->AddHistogram(histClass, "DeltaPt_500_wide", "", false, 500, -5.0, 5.0, VarManager::kDeltaPt_check);
      ...
      hm->AddHistogram(histClass, "Eta_vs_EtaMC", "#eta vs MC #eta", false, 50, -2.2, -4.2, VarManager::kEta, 50, -2.2, -4.2, VarManager::kMCEta);
      hm->AddHistogram(histClass, "Phi_vs_PhiMC", "#varphi vs MC #varphi", false, 50, 0.0, 6.3, VarManager::kPhi, 50, 0.0, 6.3, VarManager::kMCPhi);
      hm->AddHistogram(histClass, "ptMCVsEtaMC", "etaMC vs ptMC", false, 100, -4.2, -2.2, VarManager::kMCEta, 100, 0., 20., VarManager::kMCPt);
    }
  }
